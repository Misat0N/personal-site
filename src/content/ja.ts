...
export const profileJa = {
  ...
  projects: [
    ...
    { id: "llm-supply-chain", kicker: "論文 · ソフトウェア工学", title: "大規模言語モデルのサプライチェーン・セキュリティ", subtitle: "第三著者", period: "2025.03 — 2025.05", status: "Internetware 2026", summary: "13,486件のオープンソースパッケージと180件の脆弱性を対象に、LLMサプライチェーンの構造、機能領域、リスク伝播を実証的に分析しました。", highlights: ["28,704本の依存関係を含むグラフを構築し、中核依存と代表的なトポロジーを分析", "依存層を通じた脆弱性の連鎖的影響を定量化し、Internetware 2026に採択"], tags: ["AI Security", "Software Supply Chain", "Empirical Study"], media: { src: "/images/research/llm-supply-chain-topologies.png", alt: "LLM依存ツリーにおけるチェーン、三角形、ダイヤモンド、スター、サイクル型トポロジー", caption: "Yanzhe Huほか · 論文 Fig. 2：LLMサプライチェーン依存ツリーの代表的なトポロジー（原図を変更せず掲載）。", source: { label: "arXiv · Fig. 2", href: "https://arxiv.org/html/2504.20763v2#S3.F2" } }, links: [{ label: "概要", href: "https://arxiv.org/abs/2504.20763" }, { label: "HTML", href: "https://arxiv.org/html/2504.20763v2" }, { label: "PDF", href: "https://arxiv.org/pdf/2504.20763v2" }] },
