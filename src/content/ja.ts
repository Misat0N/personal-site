...
export const profileJa = {
  ...
  projects: [
    ...
    { id: "llm-supply-chain", kicker: "セキュリティ研究", title: "大規模言語モデルのサプライチェーン・セキュリティ", subtitle: "主要メンバー", period: "2025.03 — 2025.05", status: "Research", summary: "モデル学習、パラメータ配布、依存パッケージ構築にまたがるリスクを分析しました。", highlights: ["依存関係の集中と更新遅延を調べるリスク伝播グラフを構築", "モデル重みの汚染リスクを抑える検証可能な署名方式を検討"], tags: ["AI Security", "Supply Chain", "Risk Analysis"] },
    ...
    { id: "signal-recognition", kicker: "インテリジェント・ハードウェア", title: "パッシブIoT信号のインテリジェント識別", subtitle: "主要メンバー", period: "2025.03 — 2026.03", status: "Completed", summary: "単一周波数の反射特性とモデル駆動型ネットワークを用いた変調識別システムを構築しました。", highlights: ["アルゴリズム設計、数値実験、組込みFPGA上での検証を完了", "国家レベルの大学生イノベーション・起業訓練プロジェクトに推薦"], tags: ["Signal Recognition", "Deep Learning", "FPGA", "Passive IoT"] },
  ],
  awards: [
